...
pub enum PhysicalPlan {
    ...
    Scan {
        table_name: String,
        columns: Vec<String>,
        predicate: Option<Expression>, // Assuming Expression is from crate::logical_plan
        partition_id: Option<usize>,   // New field
        total_partitions: Option<usize>, // New field
    },
...
#[derive(Debug, thiserror::Error, Serialize, Deserialize)] // Added Serialize, Deserialize
...
mod tests {
    use super::*;
    // Removed: use crate::logical_plan::Expression as LogicalExpression;
